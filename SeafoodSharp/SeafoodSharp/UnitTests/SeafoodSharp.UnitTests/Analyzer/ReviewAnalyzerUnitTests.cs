...
public class ReviewAnalyzerUnitTests
{
    ...
    public void LastFiveReviewsFiveStarts_AllReviewsAre5()
    {
        ...
        // Act
        bool actual = ReviewAnalyzer.LastFiveReviewsAreFiveStarts([5, 5, 5, 5, 5]);
    ...
    public void LastFiveReviewsFiveStarts_Reviews1To5()
    {
        ...
        List<int> firstPartReviews = [1, 2, 3];
        List<int> secondPartReviews = [4, 5];
        List<int> reviews = [..firstPartReviews, ..secondPartReviews];
    ...
    {
        // Arrange
        List<int> reviews = [1, 2, 3, 4, 5]; // Last five reviews - reviews[0] is the last review.
        bool expected = false;
    ...
    {
        // Arrange
        List<int> reviews = [5, 4, 3, 2, 1]; // Last five reviews - reviews[0] is the last review.
        bool expected = true;
    ...
    {
        // Arrange
        List<int> reviews = [5, 5, 5, 5, 5]; // Last five reviews - reviews[0] is the last review.
        bool expected = false;
    ...
    {
        // Arrange
        List<int> reviews = [1, 3, 3, 3, 3]; // Last five reviews - reviews[0] is the last review.
        bool expected = true;
    ...
    {
        // Arrange
        List<int> reviews = [5, 3, 3, 3, 3]; // Last five reviews - reviews[0] is the last review.
        bool expected = true;
    ...
    {
        // Arrange
        List<int> reviews = [3, 3, 3, 3, 1]; // Last five reviews - reviews[0] is the last review.
        bool expected = false;
